...
<form method="post" action="<?php echo site_url('manager/'); ?>">
  <div class="row">
    <div class="large-6 columns">
      <label>First name
	<input type="text" name="first-name" value="<?php echo $manager->first_name; ?>"/>
      </label>
    </div>
    <div class="large-6 columns">
      <label>Last name
	<input type="text" name="last-name" value="<?php echo $manager->last_name; ?>"/>
      </label>
    </div>
  </div>
  <div class="row">
    <div class="large-4 columns">
      <label>Email
	<input type="text" name="email" value="<?php echo $manager->email; ?>" />
      </label>
    </div>
    <div class="large-4 columns">
      <label>Password
  ...
  <div class="row">
    <div class="large-12 columns">
      <label>Clients</label>
	<?php Client::checkboxes('manager_id', $manager->id); ?>
    </div>
  </div>
  <div class="row">
    <div class="large-12 columns">
