...
<div class="row collapse">
  ...
  <div class="small-12 columns panel section">
      <div class="aware-widget-section">
		...
		$thread = Thread::cast($thread);
          ?>
          <div class="panel aware-widget-communication-discussion">
            <h6 class="aware-thread-title"><img class="avatar" src="<?php echo AWARE_URL; ?>assets/img/avatar.png" alt="Avatar"> <a href="<?php echo $thread->getPermalink(); ?>"><?php echo $thread->subject; ?></a></h6>
<!--
